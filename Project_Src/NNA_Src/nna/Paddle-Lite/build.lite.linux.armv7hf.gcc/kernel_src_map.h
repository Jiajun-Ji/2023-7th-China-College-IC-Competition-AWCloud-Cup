...
const std::map<std::string, std::string> kernel2path_map{
  ...
  {"rnn,kARM,kFP16,kNCHW,fp16", "rnn_compute.cc"},
  ...
  {"reverse,kHost,kAny,kNCHW,def_tensor_array", "reverse_compute.cc"},
  ...
  {"meshgrid,kHost,kFloat,kAny,int64", "meshgrid_compute.cc"},
  ...
  {"less_equal,kHost,kFloat,kAny,int32", "compare_compute.cc"},
  {"greater_than,kHost,kFloat,kAny,def", "compare_compute.cc"},
  {"greater_than,kHost,kFloat,kAny,def_bool", "compare_compute.cc"},
  {"greater_than,kHost,kFloat,kAny,def_int32", "compare_compute.cc"},
  {"greater_than,kHost,kInt64,kAny,def", "compare_compute.cc"},
  {"greater_than,kHost,kFloat,kAny,def_int64", "compare_compute.cc"},
  {"greater_equal,kHost,kFloat,kAny,def", "compare_compute.cc"},
  {"greater_equal,kHost,kFloat,kAny,def_int64", "compare_compute.cc"},
  {"greater_equal,kHost,kFloat,kAny,def_int32", "compare_compute.cc"},
  ...
  {"calib_inplace,kARM,kFP16,kNCHW,fp16_to_fp32", "calib_inplace_compute.cc"},
  {"calib_inplace,kARM,kFP16,kNCHW,fp32_to_fp16", "calib_inplace_compute.cc"},
  {"sparse_conv2d,kARM,kFP16,kNCHW,def", "sparse_conv_compute.cc"},
  ...
  {"scatter,kARM,kFloat,kNCHW,ids_int64", "scatter_compute.cc"},
  {"scatter,kARM,kFloat,kNCHW,ids_int32", "scatter_compute.cc"},
  ...
  {"im2sequence,kHost,kFloat,kNCHW,def", "im2sequence_compute.cc"},
  ...
  {"sequence_expand_as,kARM,kFloat,kNCHW,int32", "sequence_expand_as_compute.cc"},
  {"sequence_expand_as,kARM,kFloat,kNCHW,int64", "sequence_expand_as_compute.cc"},
  {"merge_lod_tensor,kHost,kFloat,kNCHW,def", "merge_lod_tensor_compute.cc"},
  ...
  {"sampling_id,kHost,kAny,kAny,float32", "sampling_id_compute.cc"},
  ...
  {"matmul,kARM,kFP16,kNCHW,def", "matmul_compute.cc"},
  ...
  {"max_pool2d_with_index,kHost,kFloat,kNCHW,fp32", "max_pool_with_index_compute.cc"},
  ...
  {"strided_slice,kHost,kFloat,kNCHW,def_int32", "strided_slice_compute.cc"},
  {"strided_slice,kHost,kFloat,kNCHW,def_int64", "strided_slice_compute.cc"},
  ...
  {"tile,kHost,kFloat,kNCHW,def_int32", "tile_compute.cc"},
  {"tile,kHost,kFloat,kNCHW,def_int64", "tile_compute.cc"},
  {"tile,kHost,kFloat,kNCHW,def_int8", "tile_compute.cc"},
  ...
  {"log_softmax,kHost,kFloat,kNCHW,def", "log_softmax_compute.cc"},
  {"sequence_expand,kHost,kFloat,kNCHW,def", "sequence_expand_compute.cc"},
  {"sequence_expand,kHost,kFloat,kNCHW,int32", "sequence_expand_compute.cc"},
  {"sequence_expand,kHost,kFloat,kNCHW,int64", "sequence_expand_compute.cc"},
  ...
  {"expand_v2,kHost,kFloat,kAny,def_int32", "expand_v2_compute.cc"},
  ...
  {"roll,kHost,kFloat,kAny,def", "roll_compute.cc"},
  ...
  {"matmul_v2,kARM,kFP16,kNCHW,def", "matmul_v2_compute.cc"},
  {"matmul_v2,kARM,kFloat,kNCHW,def", "matmul_v2_compute.cc"},
  {"matmul_v2,kARM,kInt8,kNCHW,def", "matmul_v2_compute.cc"},
  ...
  {"slice,kARM,kFloat,kNCHW,array_def", "slice_compute.cc"},
  {"slice,kARM,kFloat,kNCHW,float_i64_starts_ends", "slice_compute.cc"},
  {"slice,kARM,kFloat,kNCHW,array_float_i64_starts_ends", "slice_compute.cc"},
  {"slice,kARM,kFloat,kNCHW,bool_slice", "slice_compute.cc"},
  {"slice,kARM,kFloat,kNCHW,array_bool_slice", "slice_compute.cc"},
  {"slice,kARM,kFloat,kNCHW,int32_slice", "slice_compute.cc"},
  {"slice,kARM,kFloat,kNCHW,array_int32_slice", "slice_compute.cc"},
  {"slice,kARM,kFloat,kNCHW,def_int64", "slice_compute.cc"},
  {"slice,kARM,kFloat,kNCHW,array_def_int64", "slice_compute.cc"},
  ...
  {"softplus,kHost,kFloat,kNCHW,def", "activation_compute.cc"},
  ...
  {"calib,kARM,kInt64,kNCHW,fp32_to_int64", "calib_compute.cc"},
  ...
  {"subgraph,kIntelFPGA,kInt8,kNCHW,def", "subgraph_compute.cc"},
  {"lookup_table,kARM,kAny,kNCHW,def", "lookup_table_compute.cc"},
  {"lookup_table_v2,kARM,kAny,kNCHW,def", "lookup_table_compute.cc"},
  {"lookup_table,kARM,kAny,kNCHW,float_int32", "lookup_table_compute.cc"},
  {"lookup_table_v2,kARM,kAny,kNCHW,float_int32", "lookup_table_compute.cc"},
  {"  ", "  "}
};