...
/*
 * Macros for device 'dvp_ddr3_vga_top_0_dvp_slave', class 'dvp_ddr3_vga_top'
 * The macros are prefixed with 'DVP_DDR3_VGA_TOP_0_DVP_SLAVE_'.
 * The prefix is the slave descriptor.
 */
#define DVP_DDR3_VGA_TOP_0_DVP_SLAVE_COMPONENT_TYPE dvp_ddr3_vga_top
#define DVP_DDR3_VGA_TOP_0_DVP_SLAVE_COMPONENT_NAME dvp_ddr3_vga_top_0
#define DVP_DDR3_VGA_TOP_0_DVP_SLAVE_BASE 0x840
#define DVP_DDR3_VGA_TOP_0_DVP_SLAVE_SPAN 16
#define DVP_DDR3_VGA_TOP_0_DVP_SLAVE_END 0x84f

/*
 * Macros for device 'dvp_ddr3_vga_top_0_vga_slave', class 'dvp_ddr3_vga_top'
 * The macros are prefixed with 'DVP_DDR3_VGA_TOP_0_VGA_SLAVE_'.
 * The prefix is the slave descriptor.
 */
#define DVP_DDR3_VGA_TOP_0_VGA_SLAVE_COMPONENT_TYPE dvp_ddr3_vga_top
#define DVP_DDR3_VGA_TOP_0_VGA_SLAVE_COMPONENT_NAME dvp_ddr3_vga_top_0
#define DVP_DDR3_VGA_TOP_0_VGA_SLAVE_BASE 0x850
#define DVP_DDR3_VGA_TOP_0_VGA_SLAVE_SPAN 16
#define DVP_DDR3_VGA_TOP_0_VGA_SLAVE_END 0x85f
...
#define SYSID_QSYS_TIMESTAMP 1684762278
